     ...
     <div class="container-fluid">
		<div class="col-lg-12">
            ...
            <div class="row">
		        <div class="col-md-12">
			        <div class="jumbotron">
                        <asp:Image ID="Image1" runat="server" Height="405px" ImageUrl="~/Images/large_Hero4Black_StandardHousing_0_OB-600x300.jpg" Width="809px" />
			        </div>
		        </div>
	        </div>
			<%--<div class="row">
            ...
            <div class="center-block">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idCamera"
                        ...
                        CssClass="table table-hover table-striped" CellPadding="4" ForeColor="Black" GridLines="Horizontal" 
        ...
        <ItemStyle Width="150px"></ItemStyle>
                            ...
                            <asp:TemplateField HeaderText="Model" ItemStyle-Width="100">
                                <ItemTemplate>
        ...
        <ItemStyle Width="150px"></ItemStyle>
                            ...
                            <asp:TemplateField HeaderText="CostUSD" ItemStyle-Width="100">
                                <ItemTemplate>
